...
public abstract partial class RedisHelper
{
    ...
    /// <returns></returns>
    public static CSRedisClient.SubscribeListBroadcastObject SubscribeListBroadcast(string listKey, string clientId, Action<string> onMessage, int timeout) => Instance.SubscribeListBroadcast(listKey, clientId, onMessage, timeout);
    /// <summary>
    ...
    /// <param name="timeout">超时时间 配合syncTimeout修改</param>
    /// <returns></returns>
    public static CSRedisClient.SubscribeListObject SubscribeList(string listKey, Action<string> onMessage, int timeout) => Instance.SubscribeList(listKey, onMessage, timeout);
    /// <summary>
    /// 使用lpush + blpop订阅端（多端争抢模式），只有一端收到消息
    /// </summary>
    /// <param name="listKey">list key（不含prefix前辍）</param>
    ...
    /// <returns></returns>
    public static CSRedisClient.SubscribeListObject SubscribeList(string listKey, Action<string> onMessage, int timeout, bool ignoreEmpty) => Instance.SubscribeList(listKey, onMessage, timeout, ignoreEmpty);
    #endregion
